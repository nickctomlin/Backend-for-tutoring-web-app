...
const FavoriteList = () => {
    ...
    <div className="container">
      ...
      <div className="appointment" data-id="1">
        ...
        <button className="cancel-btn">Remove from Favorites</button>
      </div>
      <br></br>
      ...
      <div className="appointment" data-id="3">
        ...
        <button class ="cancel-btn">Remove from Favorites</button>
      </div>
      <div className="appointment" data-id="4">
        ...
        <button className="cancel-btn">Remove from Favoritest</button>
      </div>
      </div>
  </section>
  </div>
